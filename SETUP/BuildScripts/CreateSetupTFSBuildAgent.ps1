...
heat dir "$TFS_BUILD_INPUT_SETUP_FRONTEND" `
		-cg cgrp_Files_TestService01Frontend `
		-dr DIR_PITWEBAPPROOT_MODULESERVICE `
		-gg -g1 -scom -sreg -srd `
		-var "var.DropFolderTestService01Frontend" `
		-out .\Components\cgrp_Files_TestService01Frontend.wxs
...
candle `
      ...
      .\Components\cgrp_Files_TestService01Frontend.wxs `
	  ...
	  -dDropFolderEngineeringscripts="$TFS_BUILD_INPUT_SETUP_ENGINEERINGSCRIPTS" `
		...
		-dDropFolderTestService01Frontend="$TFS_BUILD_INPUT_SETUP_FRONTEND" `
