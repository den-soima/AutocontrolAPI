...
namespace TestService02.Implementation.Config
{
    ...
    public class ConfigurationConstants
    {
        ...
        /// </summary>
        public const string TestService02ConfigFileName = "TestService02.Config.json";

        /// <summary>
        /// This should be set to the techname of the module.
        /// </summary>
        public const string ModuleIdentifier = "TestModule01";
        ...
        /// </summary>
        public const string ModuleServiceIdentifier = "TestService02";
        ...
        /// </summary>
        public const string ConfigSectionName = "TestService02Settings";
    }
}
