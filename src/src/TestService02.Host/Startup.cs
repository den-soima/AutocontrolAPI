...
using TestService02.Implementation;
using TestService02.Implementation.Config;
using TestService02.Host.Services;
...
using Factory = TestService02.Implementation.Factory;
...
namespace TestService02.Host
{
    ...
    public class Startup
    {
        ...
        private readonly TestService02Settings settings;
        ...
        public Startup(IConfiguration configuration, IWebHostEnvironment env)
        {
            ...
            this.settings = ServiceTools.GetServiceSettings<Startup, TestService02Settings>(ConfigurationConstants.ConfigSectionName);
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ServiceConfiguration, TestService02Configuration>();

            services.AddSingleton<TestService02Settings>(this.settings);
            ...
            Implementation.Factory.AddTestService02Services(services, settings);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, TestService02Settings settings, LogConfiguration logSettings, IHostApplicationLifetime applicationLifetime)
        {
