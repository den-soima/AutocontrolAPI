...
namespace AutocontrolService.Implementation.Controllers.V1
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        [Produces(typeof(List<Dashboard>))] //Required for API-Documentation; this way required data structures are also documented.
        public IActionResult GetAll()
        {
            try
            {
                var autocontrols = _dashboardRepository.GetAll();              
