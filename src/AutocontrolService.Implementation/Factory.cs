...
using AutocontrolService.Implementation.Controllers.V1;
...
using AutocontrolService;
using AutocontrolService.Data.Services;
using Microsoft.EntityFrameworkCore;

namespace AutocontrolService.Implementation
{
    /// <summary>
    ...
    public static class Factory
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static IServiceCollection AddAutocontrolServiceServices(this IServiceCollection services, AutocontrolServiceSettings settings)
        {
        ...
        /// </summary>
        public static void Configure(IApplicationBuilder app, IWebHostEnvironment env, AutocontrolServiceSettings settings, LogConfiguration logSettings)
        {
        ...
        /// </summary>
        public static IServiceCollection AddAuthenticationConfigurations(this IServiceCollection services, AutocontrolServiceSettings settings)
        {
