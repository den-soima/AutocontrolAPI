    ...
    public class Program
    {
        ...
        public static IWebHostBuilder CreateWebHostBuilder(string[] args)
        {
            ...
            IWebHostBuilder webHostBuilder = WebHost.CreateDefaultBuilder()
                   .UseStartupWithConfiguration<Startup, AutocontrolServiceConfiguration>(args, out serviceSettings)
                   .UseWebRoot(Path.Combine(serviceSettings.System.PiTWebPubPath, "approot", ConfigurationConstants.ModuleIdentifier, ConfigurationConstants.ModuleServiceIdentifier, "wwwroot"))
                   .UseKestrelWithListenSettings<AutocontrolServiceSettings>();
