...
using AutocontrolService.Implementation;
using AutocontrolService.Implementation.Config;
using AutocontrolService.Host.Services;
...
using Factory = AutocontrolService.Implementation.Factory;
using PlantiT.Base.ServiceBootstrapping.SwaggerConfiguration;
using System.IO;

namespace AutocontrolService.Host
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        private readonly AutocontrolServiceSettings settings;
        ...
        public Startup(IConfiguration configuration, IWebHostEnvironment env)
        {
            ...
            this.settings = ServiceTools.GetServiceSettings<Startup, AutocontrolServiceSettings>(ConfigurationConstants.ConfigSectionName);
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ServiceConfiguration, AutocontrolServiceConfiguration>();

            services.AddSingleton<AutocontrolServiceSettings>(this.settings);
            ...
            Implementation.Factory.AddAutocontrolServiceServices(services, settings);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, AutocontrolServiceSettings settings, LogConfiguration logSettings, IHostApplicationLifetime applicationLifetime)
        {
